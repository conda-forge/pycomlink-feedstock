...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pycomlink-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6927&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pycomlink-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pycomlink` can be installed with:

```
conda install pycomlink
```

It is possible to list all of the versions of `pycomlink` available on your platform with:
